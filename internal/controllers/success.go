...
func Success() echo.HandlerFunc {
	...
	return func(c echo.Context) error {
		data := models.GetDefaultSite("Success")

		html, err := helpers.GeneratePage(views.Success(data))

		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, "Could not parse page success")
		}
